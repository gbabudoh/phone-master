    ...
    <div className="mb-6 rounded-lg border border-primary/20 bg-gradient-to-r from-primary/5 to-primary/10 p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-foreground/60">Wholesale Seller Account</p>
        </div>
        <RoleBadge role={user.role} />
      </div>
      <div className="mt-3 flex items-center space-x-2 text-xs text-primary">
        <Building2 className="h-3 w-3" />
        <span>5% Commission Rate • Bulk Pricing</span>
      </div>
    </div>
  );
}

export default function WholesaleDashboardLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  return (
    <ProtectedRoute requiredRoles={['wholesale_seller']}>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-8 rounded-lg border border-accent-grey/20 bg-white p-6">
              <UserInfo />
              <h2 className="mb-6 text-xl font-bold text-foreground">Wholesale Dashboard</h2>
              <nav className="space-y-2">
                <Link
                  href="/wholesale-seller/dashboard"
                ...
                <Link
                  href="/wholesale-seller/dashboard/inventory"
                  className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent-cyan-light cursor-pointer"
                >
                ...
                <Link
                  href="/wholesale-seller/dashboard/analytics"
                  className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent-cyan-light cursor-pointer"
                >
                ...
                <Link
                  href="/wholesale-seller/dashboard/orders"
                  className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent-cyan-light cursor-pointer"
                >
                ...
                <Link
                  href="/wholesale-seller/dashboard/messages"
                  className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent-cyan-light cursor-pointer"
                >
                ...
                <Link
                  href="/wholesale-seller/dashboard/payouts"
                  className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent-cyan-light cursor-pointer"
                >
                ...
                <Link
                  href="/wholesale-seller/dashboard/settings"
                  className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent-cyan-light cursor-pointer"
                >
