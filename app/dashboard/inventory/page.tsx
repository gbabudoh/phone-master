    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-foreground/60">Manage your product listings</p>
        </div>
        <Link
      ...
      {loading ? (
                ...
                <tr key={product._id} className="hover:bg-accent-cyan-light/30">
                  ...
                  <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <Link
                        href={`/personal-seller/dashboard/inventory/${product._id}`}
        ...
        <div className="rounded-lg border border-accent-grey/20 bg-white p-12 text-center">
          ...
          <Link
            href="/personal-seller/dashboard/inventory/new"
            className="mt-4 inline-flex items-center space-x-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-dark"
          >
            <Plus className="h-4 w-4" />
