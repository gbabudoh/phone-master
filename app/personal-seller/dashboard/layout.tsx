...
function AdminPanelLink() {
  ...
  // Only show Admin Panel link for wholesale_seller
    ...
    <div className="mb-6 rounded-lg border border-accent-grey/20 bg-white p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-foreground/60">{getRoleDisplayName()}</p>
        </div>
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-8 rounded-lg border border-accent-grey/20 bg-white p-6">
              ...
              <nav className="space-y-2">
                <Link
                  href="/personal-seller/dashboard"
                ...
                <Link
                  href="/personal-seller/dashboard/messages"
                  className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent-cyan-light cursor-pointer"
                >
                ...
                <Link
                  href="/personal-seller/dashboard/payouts"
                  className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent-cyan-light cursor-pointer"
                >
                ...
                <Link
                  href="/personal-seller/dashboard/settings"
                  className="flex items-center space-x-3 rounded-lg px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent-cyan-light cursor-pointer"
                >
                  <Settings className="h-4 w-4" />
                  <span>Settings</span>
                </Link>
                {/* Admin Only Links - Only show for wholesale_seller */}
                <AdminPanelLink />
              </nav>
            </div>
          </aside>
